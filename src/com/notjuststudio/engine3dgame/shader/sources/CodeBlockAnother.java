 ...
 */
public class CodeBlockAnother {

    private static final String DEFAULT_PATH = packageToString(CodeBlockAnother.class);
    ...
    public CodeBlockAnother(String file) {
